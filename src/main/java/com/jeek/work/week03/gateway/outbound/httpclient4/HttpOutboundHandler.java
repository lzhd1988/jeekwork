package com.jeek.work.week03.gateway.outbound.httpclient4;



import com.jeek.work.week02.work02.HttpClientUtils;
...
public class HttpOutboundHandler {
    ...
    public void handle(final FullHttpRequest fullRequest, final ChannelHandlerContext ctx) {
        ...
        try {
            ...
            //
            String body = HttpClientUtils.getAsString(url);
